...
def train_saboteur_only(results_dir, n_qubits, saboteur_steps, n_steps, baseline_circuit_path=None, lambda_penalty=0.5):
    """
    ...
    model = PPO("MultiInputPolicy", env, **agent_params)
